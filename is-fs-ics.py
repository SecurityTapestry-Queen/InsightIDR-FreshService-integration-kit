...
def getInsightInvestigations():
    print("Getting Open Investigations for ICS")
    url = "https://us2.api.insight.rapid7.com/idr/v2/investigations"
    headers = {"X-Api-Key": IDR_API_ICS, "Accept-version": "investigations-preview"}
    params = {
...
def updateLastTime():
    lasttime = open("lasttime-ics.txt", "w")
...
def getInvestigationComments(id):
    ...
    headers = {"X-Api-Key": IDR_API_ICS, "Accept-version": "comments-preview"}
